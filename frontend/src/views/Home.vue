<template>
    <div>
      <div id="default-carousel" class="relative" data-carousel="slide">
        <div
            class="overflow-hidden relative h-56 sm:h-64 xl:h-80 2xl:h-96"
        >
          <div
          ...
          >
            <img
                src="/src/assets/images/Group%204.png"
          ...
          >
            <img
                src="/src/assets/images/garantie.png"
                class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2"
                alt="..."
            />
          </div>
      ...
      <div class="hidden md:block">
        <div class="flex items-center justify-center md:mt-10 md:p-4 w-full md:grid-cols-3 md:gap-20">
          <div class="w-[240px] h-[164px]">
            <img src="/src/assets/images/anaca3-complement-alimentaire-300-125.jpg">
          </div>
          <div class="w-[240px] h-[164px]">
            <img src="/src/assets/images/avis-client-pharmarket-300-125.jpg">
          </div>
          <div class="w-[240px] h-[164px]">
            <img src="/src/assets/images/cotopads-velpeau-300-125.jpg">
          </div>
        </div>
      </div>
      <!--    Product divider-->
      <div class="flex flex-col mb-3">
        ...
        <span class="bg-gray-700 ml-10 mr-10  w-90% h-[1px]"></span>
      </div>
      <!--    Card carousel-->
